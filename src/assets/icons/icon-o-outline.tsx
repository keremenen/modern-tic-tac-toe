import { cn, extractFillClass } from '../../lib/utils'

type IconOOutlineProps = {
  className?: string
}

export default function IconOOutline({ className }: IconOOutlineProps) {
  const fillClass = extractFillClass(className)
